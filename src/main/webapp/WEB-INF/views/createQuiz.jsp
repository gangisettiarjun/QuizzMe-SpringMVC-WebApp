...
<%int count=1; %>						
		<form action="/quizzme/quiz/create" method="POST" class="form-horizontal">

			

			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">Quiz Name:</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="quizName"	placeholder="Quiz name" required>
				</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-2 control-label">Category For Your
					Quiz:</label>
				<div class="col-sm-4">
				...
				<div class="col-sm-4">
					<select class="form-control" name="level">
						...
						<c:forEach items="${levelList}" var="level">
							<option value="<%=count %>">${level}</option>
							<% count=count+1; %>
						</c:forEach>
					</select>
				</div>
			...
			<br>
			<button type="submit" class="btn btn-info">Create quiz and questions</button>
</form>						
