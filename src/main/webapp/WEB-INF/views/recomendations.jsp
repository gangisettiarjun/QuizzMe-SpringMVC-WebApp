		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="/quizzme/quiz/search"><span class="glyphicon glyphicon-thumbs-up"></span>
			...
			<div class="col-sm-9col-sm-offset-3 col-md-10 main"
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<label>Recommend the quiz to your friend..</label>
						
						<form:form action="/quizzme/quizzes/recommend" method="POST"
							>
							<input type="hidden" name="quizId" value="${quiz.id}"></input>
							<input type="text" name="recommendeeEmail" placeholder="Enter your friend's email address" style="  width: 366px;
  margin-bottom: 2%;" class="form-control"></input>
							</br>
